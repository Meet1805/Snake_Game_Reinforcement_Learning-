...
│
└── snake-ai/               # Main application folder
...
2. Clone or download this repository:
   ```bash
   git clone https://github.com/Meet1805/Snake_Game_Reinforcement_Learning-.git
   ```
3. Open a terminal and navigate to the `snake-ai` directory:
   ```bash
   cd Snake_Game_Reinforcement_Learning-/snake-ai
   ```
...
To start the AI training, make sure you are in the `snake-ai` directory and run the `main.py` file:
```bash
python main.py
```
